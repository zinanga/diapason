...
function App() {
  ...
  // The payload is the backend error reason (also logged to handy.log).
  useEffect(() => {
  ...
  const toaster = (
    <Toaster
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "bg-background border border-mid-gray/20 rounded-lg px-4 py-3 flex items-center gap-3 text-sm",
          title: "font-medium",
